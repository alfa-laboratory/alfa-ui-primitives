...
const SvgIconBankYandexmoneyLWhite = props => (
  <svg width={30} height={30} {...props}>
    <defs>
      <path
        id="icon_bank-yandexmoney_l_white_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(5 1.25)">
        <mask id="icon_bank-yandexmoney_l_white_svg__b" fill="#fff">
          <use xlinkHref="#icon_bank-yandexmoney_l_white_svg__a" />
        </mask>
        <path
          ...
          fill="#FFF"
          mask="url(#icon_bank-yandexmoney_l_white_svg__b)"
        />
        <path
          fillOpacity={0.3}
          fill="#0B1F35"
...
export default SvgIconBankYandexmoneyLWhite;
